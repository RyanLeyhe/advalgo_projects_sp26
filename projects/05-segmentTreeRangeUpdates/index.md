...
**NOTE THAT THIS IS NOT JUST A TEMPLATE.**
...
- Implementations:
	- [C++](./implementations/cpp/segmentTree.cpp)
	- [Java](./implementations/java/SegmentTree.java)
	- [Python](./implementations/python/segmentTree.py)
	- io
...
- [Presentation Slides](./slides/presentation_segmentTreeRangeUpdates.pptx)


<a name="overview"></a>Programming Challenge
---------------------------------------

- [Programming Challenge](./programmingChallenge/Evil_CEO.pdf)
	- Solutions:
		- [Java](./programmingChallenge/Solution.java)
	- Test Cases:
